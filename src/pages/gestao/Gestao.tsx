...
import { Users, Archive, FileText, UserCircle, ChevronRight, Landmark } from 'lucide-react';
...
const cards = [
  ...
  { label: 'Tesouraria', desc: 'Gestão da conta corrente e movimentos', href: '/gestao/tesouraria', icon: Landmark },
];
